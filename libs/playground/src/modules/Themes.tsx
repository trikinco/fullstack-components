...
export const Themes = memo(function Themes({
	...
	return (
		<fieldset id={id} className="flex gap-3">
			...
			{themes.map(({ name, image }) => (
				...
				>
					...
					/>
					<span className="group/icon bg-white dark:bg-black w-20 h-20 rounded-md ring-black ring-offset-2 dark:ring-white dark:ring-offset-black peer-focus-visible:ring-blue-400 peer-focus-visible:ring-offset-inherit opacity-80 hover:opacity-100 peer-checked:opacity-100 peer-checked:ring-2 transition-opacity ease-in-out">
